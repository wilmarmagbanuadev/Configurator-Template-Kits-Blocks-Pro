...
//class CONFIGURATOR_TEMPLATE_KITS_BLOCK_Pro_Admin_Settings {
    ...
    public function blank_admin_body_class( $classes ) {
    	...
    	if($screen->base == 'configurator_template_kits_blocks' || $screen->base == 'configurator_template_kits_blocks-license' ) {
	    	$classes .= ' blank_panel ';
	 	}
	    return $classes;
