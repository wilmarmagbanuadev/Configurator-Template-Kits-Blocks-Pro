 ...
 * @since 1.0.0
 */
final class Configurator_Template_Kits_Blocks_Extension_Init {
	...
	*/
	...
	public function includes() {
		//require_once Configurator_Template_Kits_Blocks_PATH . 'admin/class-configurator-template-kits-blocks-admin.php';
	...
	public function front_enqueue_styles() {
		wp_enqueue_style( 'configurator-template-kits-blocks-style', Configurator_Template_Kits_Blocks_URL . 'assets/css/configurator-template-kits-blocks-style.css', [], Configurator_Template_Kits_Blocks_VERSION );
...
Configurator_Template_Kits_Blocks_Extension_Init::instance();